...
@Component
@Slf4j
public class RestReactiveHealthIndicator implements HealthIndicator {

    private final RestClient restClient;
    private final String restUrl;

    public RestReactiveHealthIndicator(@Value("${security.reactive-health-url}") String restUrl) {
